...
```
cd existing_repo
git remote add origin https://gitlab.com/mobile-developers2/ndr-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mobile-developers2/ndr-api/-/settings/integrations)
